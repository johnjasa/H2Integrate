...
- [``NPVFinance``](npvfinance:npvfinancemodel): calculates the net present value of a commodity using the [Numpy Financial npv](https://numpy.org/numpy-financial/latest/npv.html#numpy_financial.npv) method.
